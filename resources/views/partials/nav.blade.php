...
<nav class="fixed top-0 w-full z-50 transition-all duration-500 organic-easing h-16 md:h-24 flex justify-between items-center px-4 md:px-8 lg:px-16 max-w-full" id="topNav">
    <div class="flex items-center gap-2 md:gap-3">
        <div class="bg-primary/10 p-2 md:p-3 rounded-full flex items-center justify-center">
            <span class="material-symbols-outlined text-primary text-xl md:text-3xl" style="font-variation-settings: 'FILL' 1;">eco</span>
        </div>
