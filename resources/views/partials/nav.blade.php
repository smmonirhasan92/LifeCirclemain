...
<nav class="fixed top-0 w-full z-50 transition-all duration-500 organic-easing h-24 flex justify-between items-center px-8 lg:px-16 max-w-full" id="topNav">
    <div class="flex items-center gap-3">
        ...
        <div class="flex flex-col">
            ...
            <span class="text-[10px] text-secondary font-bold tracking-tighter uppercase">Medical & Health</span>
        </div>
    </div>
    ...
    <a href="{{ route('enroll') }}" class="btn-interact bg-primary text-on-primary px-6 py-2.5 rounded-full font-manrope font-bold hover:brightness-110 shadow-lg">
        Book Appointment
    </a>
</nav>
